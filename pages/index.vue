...
.index {
  ...
  &__head {
    ...
    padding: 5rem;
    color: #ffffff;
    background: linear-gradient(245deg, #2e8ce4, #5ccef0, #5c8df0);
    background-size: 600% 600%;

    -webkit-animation: AnimatedBackground 30s ease infinite;
    -moz-animation: AnimatedBackground 30s ease infinite;
